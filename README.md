...
| 4 | Hyperparameter Tuning with Optuna + MLflow | [mlops-hyperparameter-tuning](https://github.com/jumma786/mlops-hyperparameter-tuning) | ✅ |
| **5** | **FastAPI + Docker + Cloud Run** | [mlops-model-serving](https://github.com/jumma786/mlops-model-serving) | ✅ This repo |
